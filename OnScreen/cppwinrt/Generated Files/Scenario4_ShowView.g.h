...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct __declspec(empty_bases) Scenario4_ShowView_base : implements<D, SDKTemplate::Scenario4_ShowView, composing, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = Scenario4_ShowView_base;
        using class_type = SDKTemplate::Scenario4_ShowView;
        using implements_type = typename Scenario4_ShowView_base::implements_type;
        using implements_type::implements_type;
        using composable_base = Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"SDKTemplate.Scenario4_ShowView";
        }
        Scenario4_ShowView_base()
        {
...
namespace winrt::SDKTemplate::factory_implementation
{
    ...
    struct __declspec(empty_bases) Scenario4_ShowViewT : implements<D, Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = SDKTemplate::Scenario4_ShowView;
...
#if defined(WINRT_FORCE_INCLUDE_SCENARIO4_SHOWVIEW_XAML_G_H) || __has_include("Scenario4_ShowView.xaml.g.h")
#include "Scenario4_ShowView.xaml.g.h"
#else

namespace winrt::SDKTemplate::implementation
{
    template <typename D, typename... I>
    using Scenario4_ShowViewT = Scenario4_ShowView_base<D, I...>;
}
