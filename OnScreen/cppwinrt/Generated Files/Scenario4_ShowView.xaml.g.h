...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct Scenario4_ShowViewT : public ::winrt::SDKTemplate::implementation::Scenario4_ShowView_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename Scenario4_ShowViewT::base_type;
        using base_type::base_type;
        using class_type = typename Scenario4_ShowViewT::class_type;
    ...
    private:
        struct Scenario4_ShowView_obj1_Bindings;
