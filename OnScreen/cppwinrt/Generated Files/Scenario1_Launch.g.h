...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct __declspec(empty_bases) Scenario1_Launch_base : implements<D, SDKTemplate::Scenario1_Launch, composing, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = Scenario1_Launch_base;
        using class_type = SDKTemplate::Scenario1_Launch;
        using implements_type = typename Scenario1_Launch_base::implements_type;
        using implements_type::implements_type;
        using composable_base = Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"SDKTemplate.Scenario1_Launch";
        }
        Scenario1_Launch_base()
        {
...
namespace winrt::SDKTemplate::factory_implementation
{
    ...
    struct __declspec(empty_bases) Scenario1_LaunchT : implements<D, Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = SDKTemplate::Scenario1_Launch;
...
#if defined(WINRT_FORCE_INCLUDE_SCENARIO1_LAUNCH_XAML_G_H) || __has_include("Scenario1_Launch.xaml.g.h")
#include "Scenario1_Launch.xaml.g.h"
#else

namespace winrt::SDKTemplate::implementation
{
    template <typename D, typename... I>
    using Scenario1_LaunchT = Scenario1_Launch_base<D, I...>;
}
