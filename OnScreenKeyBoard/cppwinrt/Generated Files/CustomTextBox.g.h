...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct __declspec(empty_bases) CustomTextBox_base : implements<D, SDKTemplate::CustomTextBox, composing, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = CustomTextBox_base;
        using class_type = SDKTemplate::CustomTextBox;
        using implements_type = typename CustomTextBox_base::implements_type;
        using implements_type::implements_type;
        using composable_base = Windows::UI::Xaml::Controls::TextBox;
        hstring GetRuntimeClassName() const
        {
            return L"SDKTemplate.CustomTextBox";
        }
        CustomTextBox_base()
        {
            impl::call_factory<Windows::UI::Xaml::Controls::TextBox, Windows::UI::Xaml::Controls::ITextBoxFactory>([&](Windows::UI::Xaml::Controls::ITextBoxFactory const& f) { [[maybe_unused]] auto winrt_impl_discarded = f.CreateInstance(*this, this->m_inner); });
        }
    };
}
namespace winrt::SDKTemplate::factory_implementation
{
    ...
    struct __declspec(empty_bases) CustomTextBoxT : implements<D, Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = SDKTemplate::CustomTextBox;
...
#if defined(WINRT_FORCE_INCLUDE_CUSTOMTEXTBOX_XAML_G_H) || __has_include("CustomTextBox.xaml.g.h")
#include "CustomTextBox.xaml.g.h"
#else

namespace winrt::SDKTemplate::implementation
{
    template <typename D, typename... I>
    using CustomTextBoxT = CustomTextBox_base<D, I...>;
}
