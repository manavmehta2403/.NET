...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct __declspec(empty_bases) Scenario3_ShowHideMethods_base : implements<D, SDKTemplate::Scenario3_ShowHideMethods, composing, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, Windows::UI::Xaml::IUIElementOverrides9, I...>,
    ...
    {
        using base_type = Scenario3_ShowHideMethods_base;
        using class_type = SDKTemplate::Scenario3_ShowHideMethods;
        using implements_type = typename Scenario3_ShowHideMethods_base::implements_type;
        using implements_type::implements_type;
        using composable_base = Windows::UI::Xaml::Controls::Page;
        hstring GetRuntimeClassName() const
        {
            return L"SDKTemplate.Scenario3_ShowHideMethods";
        }
        Scenario3_ShowHideMethods_base()
        {
...
namespace winrt::SDKTemplate::factory_implementation
{
    ...
    struct __declspec(empty_bases) Scenario3_ShowHideMethodsT : implements<D, Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = SDKTemplate::Scenario3_ShowHideMethods;
...
#if defined(WINRT_FORCE_INCLUDE_SCENARIO3_SHOWHIDEMETHODS_XAML_G_H) || __has_include("Scenario3_ShowHideMethods.xaml.g.h")
#include "Scenario3_ShowHideMethods.xaml.g.h"
#else

namespace winrt::SDKTemplate::implementation
{
    template <typename D, typename... I>
    using Scenario3_ShowHideMethodsT = Scenario3_ShowHideMethods_base<D, I...>;
}
