...
namespace WPFApp
{
  ...
  public partial class MainWindow : Window
  {
    ...
    private async void PreviousImageButton_ClickAsync(object sender, RoutedEventArgs e)
    {
      if (currentNumber > 1)
      {
        currentNumber -= 1;
    ...
    private async void NextImageButton_ClickAsync(object sender, RoutedEventArgs e)
    {
