...
namespace winrt::SDKTemplate::implementation
{
    ...
    struct Scenario1_LaunchT : public ::winrt::SDKTemplate::implementation::Scenario1_Launch_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename Scenario1_LaunchT::base_type;
        using base_type::base_type;
        using class_type = typename Scenario1_LaunchT::class_type;
    ...
    private:
        struct Scenario1_Launch_obj1_Bindings;
